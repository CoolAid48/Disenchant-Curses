# Disenchant Curses
![](https://img.shields.io/badge/Loader-Fabric-purple?style=for-the-badge)
...
- **No experience points are rewarded when stripping a curse with a grindstone unlike other enchants**
- **Functions completely server-side and can be used in singleplayer**
#### Requires ONLY the [Fabric API](https://modrinth.com/mod/fabric-api) | Any bugs or issues, please make a report on [GitHub](https://github.com/CoolAid48/Disenchant-Curses/issues)
